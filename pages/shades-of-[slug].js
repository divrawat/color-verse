...
const COLOR_GROUPS = {
    ...
    'green': { hex: '#10b981', name: 'Green', description: 'Green symbolize growth, harmony, and freshness. In design, it is often used to represent nature, wealth, and stability.' },
...
export default function ShadesOfColor() {
    const router = useRouter();
    const { slug } = router.query;
    const colorData = COLOR_GROUPS[slug];
